    ...
    <div class='wrap'>
        ...
        <div class='grid'>
            <div class='card'>
                ...
                <form onsubmit="callGet(event, this)"><input type='hidden' name='fn' value='getModelId'><button
                        type='submit'>getModelId()</button></form>
                <div id="getModelId" class='display small'>Aguardando leitura.</div>
                <form onsubmit="callGet(event, this)"><input type='hidden' name='fn' value='getModelName'><button
                        type='submit'>getModelName()</button></form>
                <div id="getModelName" class='display small'>Aguardando leitura.</div>
                <form onsubmit="callGet(event, this)"><input type='hidden' name='fn' value='getFirmwareVersion'><button
                        type='submit'>getFirmwareVersion()</button></form>
                <div id="getFirmwareVersion" class='display small'>Aguardando leitura.</div>
                ...
                <form onsubmit="callGet(event, this)"><input type='hidden' name='fn' value='getMpptCount'><button
                        type='submit'>getMpptCount()</button></form>
                <div id="getMpptCount" class='display small'>Aguardando leitura.</div>
            ...
            <div class="card">
                <h2>Escritas - Controle de Reativa</h2>
                <form onsubmit="callSet(event, this)"><input type='hidden' name='fn'
                ...
                <form onsubmit="callSet(event, this)"><input type='hidden' name='fn'
                        value='setFixedReactiveEnabled'><label>Estado</label><select name='value'>
                        <option value='1'>true / habilitar</option>
                        <option value='0'>false / desabilitar</option>
                    </select><button type='submit'>setFixedReactiveEnabled()</button></form>
                <div id="setFixedReactiveEnabled" class="display small">Aguardando comando.</div>
                <form onsubmit="callSet(event, this)"><input type='hidden' name='fn'
                        value='setFixedReactiveSetpoint'><label>Valor</label><input type='number' step='0.01'
                        name='value'><button type='submit'>setFixedReactiveSetpoint()</button></form>
                <div id="setFixedReactiveSetpoint" class="display small">Aguardando comando.</div>
                <h2>Leituras - Controle de Reativa</h2>
                ...
                <form onsubmit="callGet(event, this)"><input type='hidden' name='fn' value='isFixedReactiveEnabled'><button
                        type='submit'>isFixedReactiveEnabled()</button></form>
                <div id="isFixedReactiveEnabled" class='display small'>Aguardando leitura.</div>
                <form onsubmit="callGet(event, this)"><input type='hidden' name='fn' value='getFixedReactiveSetpoint'><button
                        type='submit'>getFixedReactiveSetpoint()</button></form>
                <div id="getFixedReactiveSetpoint" class='display small'>Aguardando leitura.</div>
            </div>
            <div class='card'>
        ...
        <div class='card'>
            <form action='/config/apply' method='GET'><label>Modelo do inversor</label><select name='model'>
                ...
                <div class='row'>
                    ...
                    <div><label>Pino DE/RE</label><input type='number' name='dere' min='-1' max='16' value='-1'></div>
                </div>
